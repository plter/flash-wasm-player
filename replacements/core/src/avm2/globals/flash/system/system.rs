...
pub fn js_env<'gc>(
    ...
    Ok(AvmString::new(_activation.context.gc_context, _activation.context.external_interface.get_js_env()).into())
}
...
pub fn create_class<'gc>(mc: MutationContext<'gc, '_>) -> GcCell<'gc, Class<'gc>> {
    ...
    write.define_class_trait(Trait::from_method(
        QName::new(Namespace::public(), "js_env"),
        Method::from_builtin(js_env),
    ));
